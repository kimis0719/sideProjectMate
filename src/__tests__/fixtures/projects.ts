...
export const mockProjectRecruiting = {
  ...
  members: [
    { role: '백엔드 개발자', current: 1, max: 2 },
    { role: '디자이너', current: 0, max: 1 },
  ],
  tags: [],
  images: ['🚀'],
  content: '같이 사이드 프로젝트 하실 분 구합니다! React + Node.js 기반 웹 서비스입니다.',
  status: '01' as const,
  delYn: false,
  overview: '',
  resources: [],
...
export const mockProjectInProgress = {
  ...
  author: USER_IDS.bob,
  members: [
    { role: '프론트엔드 개발자', current: 2, max: 2 },
    { role: '백엔드 개발자', current: 1, max: 1 },
  ],
  tags: [],
  images: ['💻'],
  content: '현재 개발이 진행 중인 팀 프로젝트입니다.',
  status: '02' as const,
  delYn: false,
...
export const mockProjectCompleted = {
  ...
  resources: [],
  views: 256,
  likes: [USER_IDS.alice, USER_IDS.carol],
