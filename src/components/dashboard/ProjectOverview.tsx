            ...
            <div className="flex justify-between items-center mb-4">
                ...
                {isAuthor && !isEditing && (
                    <button
                        ...
                        className="transition-opacity text-xs text-slate-500 hover:text-blue-600 font-medium px-2 py-1 rounded bg-slate-50 border border-slate-100"
                    >
                        수정
                    </button>
                )}
            ...
            {isEditing ? (
                <div className="space-y-3">
                    <textarea
                        ...
                        className="w-full h-48 p-3 text-sm text-slate-700 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none bg-slate-50"
                ...
                <div className="prose max-w-none text-slate-600 whitespace-pre-wrap text-sm leading-relaxed">
                    {project.overview ? (
                        project.overview
                    ) : (
