        ...
        <div className="flex flex-wrap justify-center gap-2">
          {skills.map((skill) => (
            ...
            >
              ...
              {skill.active && (
                <span
                  className="relative flex h-1.5 w-1.5 flex-shrink-0 ml-2"
    ...
    <div className="mb-4 text-center">
      ...
      <div className="flex flex-wrap justify-center gap-1.5">
        {skills.map((skill) => (
          <div
            key={skill.name}
            className="inline-flex items-center px-2.5 py-1 rounded-md bg-muted/50 border border-border text-xs text-foreground hover:bg-muted transition-colors"
          >
