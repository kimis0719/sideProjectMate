  ...
  useEffect(() => {
    ...
    const fetchProjectMembers = async () => {
      try {
        ...
        // 중복 제거
        const unique = members.filter((m, i, self) => i === self.findIndex((s) => s._id === m._id));
    ...
    <div className="flex flex-col min-h-full">
      ...
      <div className="flex items-center justify-between px-6 py-4 bg-card border-b border-border">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">프로젝트 {pid}의 작업 타임라인</p>
        </div>
      ...
      <div className="p-6 space-y-6">
        ...
        {/* 작업 목록 (접기/펴기) */}
        <TaskList tasks={tasks} selectedTaskId={selectedTaskId} onTaskOpen={openTask} />
      </div>
