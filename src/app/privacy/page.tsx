        ...
        <div className="prose prose-slate dark:prose-invert max-w-none space-y-10 text-foreground">
              ...
              <table className="w-full text-sm border-collapse border border-border">
                ...
                <tbody className="text-muted-foreground">
                  <tr>
                    ...
                    <td className="border border-border px-4 py-2">
                      본인 확인, 계정 유지 및 관리, 부정 이용 방지
                    </td>
                  </tr>
                  <tr>
                    <td className="border border-border px-4 py-2">서비스 제공</td>
                    <td className="border border-border px-4 py-2">
                      팀 매칭, 프로젝트 협업 도구(칸반·WBS·채팅) 운영
                    </td>
                  </tr>
                  <tr>
          ...
          <section>
            ...
            <div className="space-y-3 text-sm text-muted-foreground">
              <p>
                <strong className="text-foreground">사용 목적:</strong> 로그인 세션 유지(JWT 기반),
                사용자 설정 저장(다크/라이트 테마 등)
              </p>
              <p>
                <strong className="text-foreground">거부 방법:</strong> 브라우저 설정에서 쿠키를
          ...
          <section>
            ...
            <div className="bg-muted/50 border border-border rounded-lg p-4 text-sm text-muted-foreground space-y-1">
              <p>
                <strong className="text-foreground">담당 부서:</strong> [담당 부서명 기재 필요]
              </p>
              <p>
                <strong className="text-foreground">담당자 이름:</strong> [담당자 이름 기재 필요]
              </p>
              <p>
                <strong className="text-foreground">이메일:</strong> contact@sideprojectmate.com
              </p>
