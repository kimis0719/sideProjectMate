  ...
  const handleTestLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result?.ok) {
        ...
        setError(result?.error || '테스트 계정 로그인에 실패했습니다.');
      }
    } catch {
      ...
      <section className="flex flex-col items-center justify-center p-8 md:p-16 lg:p-24 bg-surface">
        <div className="w-full max-w-md">
          ...
          <div className="mb-10 text-center lg:text-left">
            <h2 className="font-headline font-semibold text-2xl text-on-surface mb-2">로그인</h2>
            <p className="font-body text-on-surface-variant">
              계정에 로그인하고 프로젝트를 이어가세요.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            >
              ...
              <span className="text-sm font-semibold">Google로 계속하기</span>
            </button>
            ...
            >
              ...
              <span className="text-sm font-semibold">GitHub로 계속하기</span>
            </button>
          </div>

          {/* 테스트 로그인 (local/test 환경에서만) */}
          {isTestEnv && (
            <>
              ...
              <form onSubmit={handleTestLogin} className="space-y-4">
                ...
                >
                  {isTestLoading ? '로그인 중...' : '테스트 계정 로그인'}
                </button>
              </form>
            </>
          )}
