...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!agreedToTerms) {
      await alert('약관 동의 필요', '이용약관 및 개인정보처리방침에 동의해주세요.');
      setIsLoading(false);
      return;
    }
        ...
        <div className="w-full max-w-sm">
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="bg-background px-3 text-muted-foreground">또는 이메일로 가입</span>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={isLoading || !isEmailValid || !isPasswordValid || !agreedToTerms}
